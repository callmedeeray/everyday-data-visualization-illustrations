...
const imgName = 'valueGradient';
const data = Array.from(Array(100).keys());

let colorScale1 = d3.scaleSequential()
  .interpolator(d3.interpolate(d3.color('hsl(270,100%,0%)'), 'hsl(270,100%,100%)'))
  //.interpolator(d3.interpolate(d3.color('hsl(270,0%,50%)'), 'hsl(270,100%,50%)')) // saturation
  .domain([0, 99])
  ;
